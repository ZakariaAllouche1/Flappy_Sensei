...
class FlappyBirdEnv(gym.Env):
    ...
    def _ensure_surface(self):
        """Crée une surface Pygame si elle n'existe pas (mode Gym)."""
        if self._surface is None:
            # Si tu vois des constantes comme SCREEN_WIDTH / SCREEN_HEIGHT dans le fichier,
            # utilise-les ici à la place des nombres.
            self._surface = pygame.Surface((800, 576))
